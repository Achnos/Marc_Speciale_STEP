...
\begin{document}
	...
	\chapter{The test- and characterization procedure}
		...
		\begin{figure}
			\centering
			\includegraphics[width=0.7\textwidth]{darkcurrent_versus_temperature_preliminary.png}
		...
		\begin{figure}
			\centering			\includegraphics[width=0.7\textwidth]{darkcurrent_versus_temperature.png}
		...
		\end{figure}
	\begin{figure}
		\centering			\includegraphics[width=0.7\textwidth]{readoutnoise_versus_temperature.png}
	...
	\end{figure}
		...
		\begin{figure}
			\centering			\includegraphics[width=0.65\textwidth]{linearity_onepixel.png}
